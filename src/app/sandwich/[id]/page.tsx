...
export async function generateMetadata(
    ...
    const description = sandwich.description || `Check out the ${sandwich.name} at ${sandwich.restaurant?.name || "a local spot"} on BrekkySammy. Rated ${sandwich.averageRating?.toFixed(1) || "N/A"} stars from ${sandwich.reviewCount || 0} reviews!`;
